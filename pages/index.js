...
import tin from '../public/images/tin.jpg'
    ...
    <div className={styles.container}>
              ...
              <div className={styles.product_container}>
                ...
                <div className={styles.product}>
                  ...
                  <p>Our Flagship Product - The Ultimate All in One Penis 
                    ...
                    therapeutic properties directly onto the erectile tissue 
                    and blood vessels for maximum growth in size - Mixed 
                    with over 10 rare Herbs only known to a few people, 
                    like the Magejo Plant, Mugolola Tree, Mukuza Roots - 
                    Instructions: You first apply a warm wet towel on your 
                    penis for a few seconds to open the foreskin pores, and 
                    relax the penis muscles then simply massage the jelly on 
                    your penis while stretching/pulling forwards for about 
                    3 mins twice a day and in about 14 days you will have 
                    achieved significant gains both length and girth. 
      ...
      <div className={styles.extra}>
        ...
        <div className={styles.order_now}>
          <div className={styles.order_now_container}>
            <h1>How to Order!</h1>
            <ol>
              <li>Choose your Intended product</li>
